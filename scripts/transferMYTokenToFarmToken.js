...
module.exports = async function (callback) {
  ...
  console.log(
    "Amount of BananaToken FarmToken is allowed to transfer on our behalf Before: " +
  ...
  console.log(
    "Amount of BananaToken FarmToken is allowed to transfer on our behalf After: " +
  ...
  console.log(
    "Balance BananaToken Before accounts[0] " +
      web3.utils.fromWei(balanceMyTokenBeforeAccounts0.toString())
  )
  console.log(
    "Balance BananaToken Before TokenFarm " +
  ...
  console.log(
    "Balance BananaToken After accounts[0] " +
      web3.utils.fromWei(balanceMyTokenAfterAccounts0.toString())
  )
  console.log(
    "Balance BananaToken After TokenFarm " +
